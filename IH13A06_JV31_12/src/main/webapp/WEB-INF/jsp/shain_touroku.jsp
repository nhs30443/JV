...
<div class="form-container">
  ...
  <s:form action="shain_touroku" method="post" theme="simple">
    <s:hidden name="ユーザID"/>
    
	<div class="input-row">
	  <label for="name">氏名：</label>
	  <s:textfield id="name" name="name" required="true" theme="simple"/>
	</div>
	
	<div class="input-row">
	  <label>性別：</label>
	  <s:radio name="gender" list="#{'M':'男性','F':'女性'}" value="M" theme="simple"/>
	</div>
	
	<div class="input-row">
	  <label for="note">備考：</label>
	  <s:textarea id="note" name="note" rows="5" cols="40" theme="simple"/>
	</div>
