...
<body>
  <div class="form-container">
    ...
    <form action="shain_touroku" method="post">
      <input type="hidden" name="ユーザID" value="">
      ...
      <label>性別：</label>
      <input type="radio" id="male" name="性別" value="M" checked>
      ...
      <textarea id="bikou" name="備考" rows="5" cols="40"></textarea>
      <br><br>
